<script lang="ts">
  ...
  const normalLinkStyle = "block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-purple-700 md:p-0 dark:text-white md:dark:hover:text-purple-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700";
  const currentLinkStyle = "block py-2 pl-3 pr-4 text-white bg-purple-700 rounded md:bg-transparent md:text-purple-700 md:p-0 md:dark:text-purple-500";
...
<nav class="p-4  border-gray-200 dark:bg-darkmode-500">
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-language">
    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      <li>
        <a href="/" class={$currentPage === "home" ? currentLinkStyle : normalLinkStyle} aria-current="page">Home</a>
      </li>
      <li>
        <a href="/about" class={$currentPage === "about" ? currentLinkStyle : normalLinkStyle}>About</a>
      </li>
      <li>
        <a href="/services" class={$currentPage === "services" ? currentLinkStyle : normalLinkStyle}>Services</a>
      </li>
      <li>
        <a href="/pricing" class={$currentPage === "pricing" ? currentLinkStyle : normalLinkStyle}>Pricing</a>
      </li>
      <li>
        <a href="/contact" class={$currentPage === "contact" ? currentLinkStyle : normalLinkStyle}>Contact</a>
      </li>
      <li>
        <button on:click={switchTheme} class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-purple-700 md:p-0 dark:text-white md:dark:hover:text-purple-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Theme</button>
      </li>
    </ul>
  </div>
  </div>
